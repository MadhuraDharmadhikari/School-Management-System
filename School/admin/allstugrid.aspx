<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="allstugrid.aspx.cs" Inherits="School.admin.allstugrid" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <!-- row -->
            ...
            <div class="card m-4">
               ...
               <div class="card m-3">
                <div class="card-body">
                    <h3 class="card-title mb-4">Conform Students</h3>
                 <%--   Gridview--%>
